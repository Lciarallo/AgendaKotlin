...
fun createContactsList(): List<Contact> {
    ...
    val pictures = listOf(
        ...
        android.R.drawable.baseline_face_24,

        android.R.drawable.baseline_face_2_24,

        android.R.drawable.baseline_face_3_24,

        android.R.drawable.baseline_face_4_24,

        android.R.drawable.baseline_face_5_24,

        android.R.drawable.baseline_face_6_24
